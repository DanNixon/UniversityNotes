...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.6\textwidth]{out/rsa-oaep.eps}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.6\textwidth]{out/rsa-oaep-dec.eps}
...
\Para{Attack on weak randomness}
...
\begin{figure}[h]
  ...
  \begin{subfigure}[t!]{0.45\textwidth}
    \centering
    \includegraphics[width=0.4\textwidth]{out/hash_and_sign_rsa.eps}
    \caption{Hash and Sign for RSA}
    \label{fig:hash_and_sign_rsa}
  \end{subfigure}
  \begin{subfigure}[t!]{0.45\textwidth}
    \centering
    \includegraphics[width=0.4\textwidth]{out/hash_and_sign.eps}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{out/interactive_proof.eps}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.6\textwidth]{out/schnorr.eps}
