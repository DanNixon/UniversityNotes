...
\begin{itemize}
  ...
  \item Instead of evolving a solution, eveolve a program
  
\end{itemize}

\subsection{Program Respresentation}
...
\begin{itemize}
  ...
  \item Leaves are either variables/parameters or constants
    \begin{itemize}
      \item Constants can be predefined or asigned a random value within a
            predefined range
    \end{itemize}
\end{itemize}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{out/gp_tree_example.eps}
...
\begin{itemize}
  \item Growth of program tree without improvment in fitness
...
\begin{description}
  \item[Regression] \hfill \\
    Reverge engineering a mathematical formula given a dataset of output values
  ...
  \item[Generating Electronic Circuits] \hfill \\
    Tree topology defines schmatic.
  ...
  \item[Puzzle Solvers] \hfill \\
    e.g. FreeCell solver using hybrig genetic algorithm and genetic
    programming.
