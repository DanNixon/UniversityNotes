...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{graphics/nw_alignment_eg.eps}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.4\textwidth]{graphics/sw_alignment_eg.eps}
