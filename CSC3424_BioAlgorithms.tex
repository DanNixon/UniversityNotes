...
\begin{itemize}
  \item
    Will always find the best possible alignment between two sequences
  ...
  \item
    ...
    \begin{description}
      \item[Global] Needleman Wunsch
      \item[Local] Small Waterman
    \end{description}
...
\begin{itemize}
  ...
  \item
    ...
    Therefore cell $(m, n)$ will contain the optimal score of the global
